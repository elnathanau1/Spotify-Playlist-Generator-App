...
/**
 * AudioFeatures object. Represents data that Spotify has generated about individual tracks.
 * @author eau
 *
 */
...
public class AudioFeatures {
	...
	//the track contains no vocal content. Values above 0.5 are intended to represent instrumental tracks, 
	...
	public String toFullString() {
		...
		returnString += "acousticness: " + acousticness + "\n";
		returnString += "analysis_url: " + analysis_url + "\n";
		returnString += "danceability: " + danceability + "\n";
		returnString += "duration_ms: " + duration_ms + "\n";
		returnString += "energy: " + energy + "\n";
		returnString += "id: " + id + "\n";
		returnString += "instrumentalness: " + instrumentalness + "\n";
		returnString += "key: " + key + "\n";
		returnString += "liveness: " + liveness + "\n";
		returnString += "loudness: " + loudness + "\n";
		returnString += "mode: " + mode + "\n";
		returnString += "speechiness: " + speechiness + "\n";
		returnString += "tempo: " + tempo + "\n";
		returnString += "time_signature: " + time_signature + "\n";
		returnString += "track_href: " + track_href + "\n";
		returnString += "type: " + type + "\n";
		returnString += "uri: " + uri + "\n";
		returnString += "valence: " + valence + "\n";
